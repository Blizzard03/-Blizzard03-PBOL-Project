 ...
 */
package Controller.Update.Master.PSU;
 ...
 * @author mariq
 */
public class UpdatePSUController implements Initializable {
    ...
    private void Save_Data_Button_Click(ActionEvent event) {
        ...
        if (Data_Edit) {
            if (Main_Menu2Controller.Database_GPU.Update_Data()) {
                Alert a = new Alert(Alert.AlertType.INFORMATION, "Update Data PSU Successed", ButtonType.OK);
                a.showAndWait();
                ...
                Alert a = new Alert(Alert.AlertType.ERROR, "Update Data PSU Failed", ButtonType.OK);
                a.showAndWait();
