...
INSERT INTO `cooler` (`ID_COOLER`, `Image`, `Nama_Cooler`, `Type`, `Socket`, `Harga`) VALUES
	...
	('MSI-MPG-K360', NULL, 'MSI MPG CORELIQUID K360', 'Liquid Cooling', 'AM4', 3000000);
...
INSERT INTO `mother_board` (`ID_MOTHER_BOARD`, `Vendor`, `Image`, `Nama_Mother_Board`, `Type`, `Socket`, `Harga`) VALUES
	...
	('MSI_MPG Z690 FORCE WIFI ', 'MSI', NULL, ' MPG Z690 FORCE WIFI ', 'ATX', 'LGA 1700', 6850000);
...
INSERT INTO `transaksi` (`Nomor_Transaksi`, `ID_User`, `Tanggal_Transaksi`, `Waktu_Transaksi`) VALUES
	('TRS_001', 101, '2022-08-29', '07:23:15');
...
INSERT INTO `user` (`ID_User`, `Image`, `Nama_User`, `Email_User`, `Alamat_User`, `Nomor_Telepon_User`, `Password`) VALUES
	...
	(110, NULL, 'Alan Wolves', 'Wolves23@Wolf.com', 'Bridge Forest', '08568456545', 'Awesome');
